...
<body>
	...
	<div id="pnCenter">
			...
			<div class="bg_display">
			    <div class="display" style="float: left; width: 100%;">
			        <div class="title_display">
			             <a style="color:#666;" href="http://icsse2017.hcmute.edu.vn/?TopicId=e821c7c7-f850-4ca3-bb37-fb63721e8d83">keynote speakers </a> <br />
			...
			</span></strong><strong><span style="font-size: 20px;">***** <span style="font-size: 20px; color: #c00000;">KEYNOTE SPEAKERS</span><br />
			...
			</span><span style="font-size: 16px; color: #002060;">Ãbuda University, Budapest, Hungary</span><br>
			...
			<table style="font-size: 14px; font-weight: bold;">
			    <tbody>
			        <tr>
			            ...
			            <div style="text-align: justify;"><span style="font-size: 14px; color: #002060;"><span style="font-weight: normal; font-size: 14px;">He is active as a full university professor. He served as the President of Budapest Tech from 2003 till 2010. He was the founder of Ãbuda University, the successor of Budapest Tec and was elected as the first President in the period 2010-2014. He served as the President of the Hungarian Rectorâs Conference and member of European University Association in 2008</span><span style="font-weight: normal; font-size: 14px;">.</span></span><br>
			            </div>
			            </span></td>
			        </tr>
			        <tr>
